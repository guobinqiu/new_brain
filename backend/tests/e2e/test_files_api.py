...
class TestFilesAPI:
    def test_list_chunks_api_uses_cursor_pagination(self, app_api_client, api_client, test_txt_path, monkeypatch):
        """``POST /api/admin/chunks`` returns vector chunks plus cursor pagination."""
        file_id = _index_ready_file(app_api_client, test_txt_path, monkeypatch)

        first_page = api_client.post("/api/admin/chunks", json={"app_id": "imsdom", "limit": 1})
        ...
        second_page = api_client.post("/api/admin/chunks", json={"app_id": "imsdom", "limit": 1, "cursor": first_body["next_cursor"]})
    ...
    def test_list_files_api_uses_cursor_pagination(self, app_api_client, api_client, test_txt_path, monkeypatch):
        """``GET /api/admin/files`` returns MinIO-backed file pages."""
        import main
        ...
        first_page = api_client.get("/api/admin/files", params={"app_id": "imsdom", "limit": 1})
        ...
        second_page = api_client.get("/api/admin/files", params={"app_id": "imsdom", "limit": 1, "cursor": first_body["next_cursor"]})
    ...
    def test_list_files_api(self, app_api_client, api_client, test_txt_path, monkeypatch):
        """``GET /api/admin/files`` lists uploaded MinIO files."""
        import main
        ...
        resp = api_client.get("/api/admin/files", params={"app_id": "imsdom"})
    ...
    def test_delete_file_api(self, app_api_client, api_client, test_txt_path, monkeypatch):
        """``DELETE /api/admin/files/{file_id}`` removes indexed chunks and MinIO object."""
        import main
        ...
        del_resp = api_client.delete("/api/admin/files/file-a", params={"app_id": "imsdom"})
    ...
    def test_delete_nonexistent(self, app_api_client, api_client, monkeypatch):
        ...
        resp = api_client.delete("/api/admin/files/ghost", params={"app_id": "imsdom"})
