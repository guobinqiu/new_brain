...
def install_mock_transport(monkeypatch) -> Callable:
    ...
    def installer(handler):
        ...
        try:
            import services.llm.src.rag.client as _rc_mod  # type: ignore
        except Exception:
...
def make_rag_client():
    ...
    def _factory(**kwargs):
        try:
            from services.llm.src.rag.client import RagClient  # type: ignore
...
def fake_search_result():
    ...
    def _factory(**overrides):
        try:
            from services.llm.src.rag.client import RagResult  # type: ignore
        except Exception:
...
def fake_document():
    ...
    def _factory(**kwargs):
        try:
            from services.llm.src.rag.schemas import Document  # type: ignore
        except Exception as exc:
