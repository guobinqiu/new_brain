...
from llm.src.agent.nodes._perf import add_perf_node
from llm.src.agent.nodes.llm import llm_node
from llm.src.agent.nodes.rag_prefetch import rag_prefetch_node
from llm.src.agent.states.base import AgentState
...
def build_chat_graph(checkpointer):
    ...
    Args:
        checkpointer: LangGraph checkpointer（生产为 AsyncPostgresSaver）。
