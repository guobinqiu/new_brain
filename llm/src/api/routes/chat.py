"""api/routes/chat.py: POST /api/open/llm/chat/stream（SSE）。"""
...
from llm.src.agent.registry import get_graph
from llm.src.api.auth import require_aksk
from llm.src.api.middleware import limiter
from llm.src.api.requests import AgentRequest
from llm.src.config import settings
from llm.src.infra.logger import get_logger, get_trace_id, set_thread_id
...
@router.post("/api/open/llm/chat/stream", dependencies=[Depends(require_aksk)])
