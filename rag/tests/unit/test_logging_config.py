...
def test_configure_logging_writes_stdout_and_optional_file(tmp_path):
    ...
    from rag.schema import LoggingConfig
    ...
    logging.getLogger("rag.app").info("uploaded", extra={"event": "upload", "document_filename": "a.pdf"})
...
def test_configure_logging_resolves_relative_file_from_project_root(monkeypatch, tmp_path):
    import rag.logging_config as logging_config
    from rag.logging_config import configure_logging
    from rag.schema import LoggingConfig
